...
const ArticleDetails = () => {
  ...
  if (!article) {
    return <div className="text-center text-lg text-gray-800 dark:text-gray-200">Article not found</div>;
  }
        ...
        <div className="p-6">
          ...
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{article.author?.email}</p>
            </div>
          </div>

          {/* Article Description */}
          <div className="mb-6">
            <p className="text-gray-700 dark:text-gray-300 text-lg">{article.description}</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Views: {" "}
              <span className="font-medium text-gray-800 dark:text-gray-200">{article.views}</span>
            </p>
            <p className="text-gray-600 dark:text-gray-400">
              Premium Article: {" "}
              <span
                className={`font-medium ${
                  article.isPremium ? "text-green-600 dark:text-green-400" : "text-gray-600 dark:text-gray-400"
                }`}
              >
                {article.isPremium ? "Yes" : "No"}
              </span>
