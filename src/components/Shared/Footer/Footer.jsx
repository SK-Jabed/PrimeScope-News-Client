        ...
        <div className="mx-auto max-w-screen-xl px-3 pb-6 pt-14 sm:px-4 lg:px-6">
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <p className="mt-2 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0 dark:text-gray-400">
              Explore our trending news and join on an innovative newspaper
              platform that combines technology.
            </p>
          </div>

          <div className="mt-8 grid grid-cols-1 gap-4 border-t border-gray-100 pt-12 md:grid-cols-4 lg:grid-cols-6 dark:border-gray-800">
            ...
            <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
              ...
              <div className="mx-auto mt-4 max-w-md sm:ms-0">
                ...
                <form className="mt-3">
                  <div className="flex flex-col gap-2 sm:flex-row lg:flex-col lg:items-start">
          ...
          <div className="mt-12 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between dark:border-gray-800">
